...
{выполнила, группа . вариант 9				}
{Зеркальная перестановка элементов списков		}
{Исходные элементы располагаются в файле FI_1.txt	}
{результаты работы располагаются в файле FO_1.txt	}
{*******************************************************}
program List_LAB;
Uses Crt, list2;
var
...
var n,i:integer;
    ...
    Pok: TValue;
    p1,p2: PItem;
begin;{Перестановка элементов в списке}
	CreateList(LB);
